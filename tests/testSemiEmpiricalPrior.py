...
lsst.pex.logging.Debug("meas.multifit.SemiEmpiricalPrior", 10)
...
class SemiEmpiricalPriorTestCase(lsst.utils.tests.TestCase):
    ...
    def setUp(self):
        ...
        self.ctrl = lsst.meas.multifit.SemiEmpiricalPrior.Control()
        ...
        self.prior = lsst.meas.multifit.SemiEmpiricalPrior(self.ctrl)

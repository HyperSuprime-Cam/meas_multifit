...
#ifndef LSST_MEAS_MULTIFIT_DETAIL_polynomials_h_INCLUDED
#define LSST_MEAS_MULTIFIT_DETAIL_polynomials_h_INCLUDED
...
#endif // !LSST_MEAS_MULTIFIT_DETAIL_polynomials_h_INCLUDED

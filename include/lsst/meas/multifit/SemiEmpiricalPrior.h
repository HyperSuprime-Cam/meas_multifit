...
#ifndef LSST_MEAS_MULTIFIT_SemiEmpiricalPrior_h_INCLUDED
#define LSST_MEAS_MULTIFIT_SemiEmpiricalPrior_h_INCLUDED
...
#endif // !LSST_MEAS_MULTIFIT_SemiEmpiricalPrior_h_INCLUDED

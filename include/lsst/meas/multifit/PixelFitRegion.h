...
#ifndef LSST_MEAS_MULTIFIT_PixelFitRegion_h_INCLUDED
#define LSST_MEAS_MULTIFIT_PixelFitRegion_h_INCLUDED
...
#endif // !LSST_MEAS_MULTIFIT_PixelFitRegion_h_INCLUDED
